...
<html lang="en">
    ...
    <body>
        ...
        <?php
            ...
            $query = "SELECT products.name, products.price, products.description, products.colour, products.product_id, products.brand FROM products WHERE products.name = 'Jordan Retro 13'"; 
            $result = mysqli_query($connection, $query); 

            //identify which gender category this shoe is
            $genderQuery = "SELECT products.gender FROM products WHERE products.name = 'Jordan Retro 13'"; 
        ...
        <div class="grid two-column add-gutters">
            ...
            <!-- shoe image -->
            <section>
                <img src="../img/JordanRetro13.png" class="scale-img box-shadow">
            </section>
            ...
            <section>
                ...
                <button type="button" class="green-button"></button>
                ...
                <?php
                    ...
                    $sizeQuery = "SELECT products.size FROM products WHERE products.name = 'Jordan Retro 13'"; 
                ...
                <div class="spacing">
                    ...
                    <button class="cart-button" name ="Jordan Retro 13">Add to Cart</button>
                
                    <!-- <input class="favourites-button" type="submit" name="favourites" value="Add to Favourites"> -->
                    <button class="favourites-button" name ="Jordan Retro 13">Add to Favourites</button>
                </div>
