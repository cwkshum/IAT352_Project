...
<html lang="en">
    ...
    <body>
        ...
        <?php
            ...
            $query = "SELECT products.name, products.price, products.description, products.colour, products.product_id, products.brand FROM products WHERE products.name = 'UGG Classic Mini'"; 
            $result = mysqli_query($connection, $query); 

            //identify which gender category this shoe is
            $genderQuery = "SELECT products.gender FROM products WHERE products.name = 'UGG Classic Mini'"; 
        ...
        <div class="grid two-column add-gutters">
            ...
            <!-- shoe image -->
            <section>
                <img src="../img/UGGClassicMini.png" class="scale-img box-shadow">
            </section>
            ...
            <section>
                ...
                <?php
                    ...
                    $sizeQuery = "SELECT products.size FROM products WHERE products.name = 'UGG Classic Mini'"; 
                ...
                <div class="spacing">
                    ...
                    <button class="cart-button" name ="UGG Classic Mini">Add to Cart</button>
                
                    <!-- <input class="favourites-button" type="submit" name="favourites" value="Add to Favourites"> -->
                    <button class="favourites-button" name ="UGG Classic Mini">Add to Favourites</button>
                </div>
