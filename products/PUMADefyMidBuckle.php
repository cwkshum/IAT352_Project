...
<html lang="en">
    ...
    <head>
        <title>PUMA Defy Mid Buckle</title> 
        <meta charset="utf-8">
    ...
    <body>
        ...
        <?php
            ...
            $query = "SELECT products.name, products.price, products.description, products.colour, products.product_id, products.brand FROM products WHERE products.name = 'PUMA Defy Mid Buckle'"; 
            $result = mysqli_query($connection, $query); 

            //identify which gender category this shoe is
            $genderQuery = "SELECT products.gender FROM products WHERE products.name = 'PUMA Defy Mid Buckle'"; 
        ...
        <div class="grid two-column add-gutters">
            ...
            <!-- shoe image -->
            <section>
                <img src="../img/PUMADefyMidBuckle.png" class="scale-img box-shadow">
            </section>
            ...
            <section>
                ...
                <button type="button" class="red-button"></button>
                ...
                <?php
                    ...
                    $sizeQuery = "SELECT products.size FROM products WHERE products.name = 'PUMA Defy Mid Buckle'"; 
                ...
                <div class="spacing">
                    ...
                    <button class="cart-button" name ="PUMA Defy Mid Buckle">Add to Cart</button>
                
                    <!-- <input class="favourites-button" type="submit" name="favourites" value="Add to Favourites"> -->
                    <button class="favourites-button" name ="PUMA Defy Mid Buckle">Add to Favourites</button>
                </div>
