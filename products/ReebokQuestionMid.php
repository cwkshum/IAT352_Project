...
<html lang="en">
    ...
    <head>
        <title>Reebok Question Mid</title> 
        <meta charset="utf-8">
    ...
    <body>
        ...
        <?php
            ...
            $query = "SELECT products.name, products.price, products.description, products.colour, products.product_id, products.brand FROM products WHERE products.name = 'Reebok Question Mid'"; 
            $result = mysqli_query($connection, $query); 

            //identify which gender category this shoe is
            $genderQuery = "SELECT products.gender FROM products WHERE products.name = 'Reebok Question Mid'"; 
        ...
        <div class="grid two-column add-gutters">
            ...
            <!-- shoe image -->
            <section>
                <img src="../img/ReebokQuestionMid.png" class="scale-img box-shadow">
            </section>
            ...
            <section>
                ...
                <?php
                    ...
                    $sizeQuery = "SELECT products.size FROM products WHERE products.name = 'Reebok Question Mid'"; 
                ...
                <div class="spacing">
                    ...
                    <button class="cart-button" name ="Reebok Question Mid">Add to Cart</button>
                
                    <!-- <input class="favourites-button" type="submit" name="favourites" value="Add to Favourites"> -->
                    <button class="favourites-button" name ="Reebok Question Mid">Add to Favourites</button>
                </div>
