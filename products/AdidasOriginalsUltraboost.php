        ...
        <div class="grid two-column add-gutters">
            ...
            <section>
                ...
                <div class="spacing">
                    ...
                    <button class="cart-button" name ="Adidas Originals Ultraboost">Add to Cart</button>
                
                    <!-- <input class="favourites-button" type="submit" name="favourites" value="Add to Favourites"> -->
                    <button class="favourites-button" name ="Adidas Originals Ultraboost">Add to Favourites</button>
                </div>
