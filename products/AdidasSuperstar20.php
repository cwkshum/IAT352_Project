...
<html lang="en">
    ...
    <head>
        <title>Adidas Superstar 20</title> 
        <meta charset="utf-8">
    ...
    <body>
        ...
        <?php
            ...
            $query = "SELECT products.name, products.price, products.description, products.colour, products.product_id, products.brand FROM products WHERE products.name = 'Adidas Superstar 20'"; 
            $result = mysqli_query($connection, $query); 

            //identify which gender category this shoe is
            $genderQuery = "SELECT products.gender FROM products WHERE products.name = 'Adidas Superstar 20'"; 
        ...
        <div class="grid two-column add-gutters">
            ...
            <!-- shoe image -->
            <section>
                <img src="../img/AdidasSuperstar20.png" class="scale-img box-shadow">
            </section>
            ...
            <section>
                ...
                <?php
                    ...
                    $sizeQuery = "SELECT products.size FROM products WHERE products.name = 'Adidas Superstar 20'"; 
                ...
                <div class="spacing">
                    ...
                    <button class="cart-button" name ="Adidas Superstar 20">Add to Cart</button>
                
                    <!-- <input class="favourites-button" type="submit" name="favourites" value="Add to Favourites"> -->
                    <button class="favourites-button" name ="Adidas Superstar 20">Add to Favourites</button>
                </div>
