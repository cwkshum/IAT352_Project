...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../css/products/nike_lebron_xvii_low.css"> 
        <!-- Google Fonts -->
    ...
    <body>
        ...
        <?php
            ...
            $query = "SELECT products.name, products.price, products.description, products.colour, products.product_id, products.brand FROM products WHERE products.name = 'Nike LeBron XVII Low'"; 
            $result = mysqli_query($connection, $query); 

            //identify which gender category this shoe is
            $genderQuery = "SELECT products.gender FROM products WHERE products.name = 'Nike LeBron XVII Low'"; 
        ...
        <div class="grid two-column add-gutters">
            ...
            <!-- shoe image -->
            <section>
                <img src="../img/NikeLeBronXVIILow.png" class="scale-img box-shadow">
            </section>
            ...
            <section>
                ...
                <?php
                    ...
                    $sizeQuery = "SELECT products.size FROM products WHERE products.name = 'Nike LeBron XVII Low'"; 
                
                    $sizeList = mysqli_query($connection, $sizeQuery); 
                    echo '<form action="NikeLeBronXVIILow.php" method="post">';
