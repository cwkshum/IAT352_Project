        ...
        <div class="grid two-column add-gutters">
            ...
            <section>
                ...
                <div class="spacing">
                    ...
                    <button class="cart-button" name ="Nike LeBron XVII Low">Add to Cart</button>
                
                    <!-- <input class="favourites-button" type="submit" name="favourites" value="Add to Favourites"> -->
                    <button class="favourites-button" name ="Nike LeBron XVII Low">Add to Favourites</button>
                </div>
