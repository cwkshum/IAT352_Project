...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../css/products/timberland_premium_waterproof_boots.css"> 
        <!-- Google Fonts -->
        ...
        <div class="grid two-column add-gutters">
            ...
            <section>
                ...
                <?php
                    ...
                    $sizeQuery = "SELECT products.size FROM products WHERE products.name = 'Timberland Premium Waterproof Boots'"; 
                
                    $sizeList = mysqli_query($connection, $sizeQuery); 
                    echo '<form action="TimberlandPremiumWaterproofBoots.php" method="post">';
