...
<html lang="en">
    ...
    <head>
        <title>Timberland Premium Waterproof Boots</title> 
        <meta charset="utf-8">
    ...
    <body>
        ...
        <?php
            ...
            $query = "SELECT products.name, products.price, products.description, products.colour, products.product_id, products.brand FROM products WHERE products.name = 'Timberland Premium Waterproof Boots'"; 
            $result = mysqli_query($connection, $query); 

            //identify which gender category this shoe is
            $genderQuery = "SELECT products.gender FROM products WHERE products.name = 'Timberland Premium Waterproof Boots'"; 
        ...
        <div class="grid two-column add-gutters">
            ...
            <!-- shoe image -->
            <section>
                <img src="../img/TimberlandPremiumWaterproofBoots.png" class="scale-img box-shadow">
            </section>
            ...
            <section>
                ...
                <?php
                    // Mens sizes
                    $sizeMenQuery = "SELECT products.size FROM products WHERE products.name = 'Timberland Premium Waterproof Boots' AND products.gender = 'Men'"; 
                    ...
                    // Womens Sizes 
                    $sizeWomenQuery = "SELECT products.size FROM products WHERE products.name = 'Timberland Premium Waterproof Boots' AND products.gender = 'Women'"; 
                ...
                <div class="spacing">
                    ...
                    <button class="cart-button" name ="Timberland Premium Waterproof Boots">Add to Cart</button>
                
                    <!-- <input class="favourites-button" type="submit" name="favourites" value="Add to Favourites"> -->
                    <button class="favourites-button" name ="Timberland Premium Waterproof Boots">Add to Favourites</button>
                </div>
